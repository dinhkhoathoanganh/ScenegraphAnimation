...
class MyHandler<K extends IVertexData> extends DefaultHandler {
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    ...
    switch (qName) {
      ...
      case "ambient":
        sc = new Scanner(data);
        setAmbient(sc.nextFloat(), sc.nextFloat(), sc.nextFloat());
        break;
      case "diffuse":
        sc = new Scanner(data);
        setDiffuse(sc.nextFloat(), sc.nextFloat(), sc.nextFloat());
        break;
      case "specular":
        sc = new Scanner(data);
        setSpecular(sc.nextFloat(), sc.nextFloat(), sc.nextFloat());
        break;
      case "emissive":
        sc = new Scanner(data);
  ...
  private void setDiffuse(float r, float g, float b) {
    if (isLight) {
  ...
  private void setSpecular(float r, float g, float b) {
    if (isLight) {
