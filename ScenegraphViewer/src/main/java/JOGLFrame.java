...
public class JOGLFrame extends JFrame {
  private static final float CAM_MOVE_STEP = 1;
  private static final float CAM_ROT_STEP = 3;

  private View view;
  private MyTextRenderer textRenderer;
  private GLCanvas canvas;

  public JOGLFrame(String title, ArgOptions ao) {
    ...
    view = new View(ao.lookAtEye, ao.lookAtCenter, ao.camRotation, ao.droneTranslate, ao.droneRotate);
    ...
    canvas.addGLEventListener(new GLEventListener() {
      @Override
      public void init(GLAutoDrawable glAutoDrawable) { //called the first time this canvas is created
        try {
  ...
  private class KeyboardListener implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
      switch (e.getKeyCode()) {
        ...
        case (KeyEvent.VK_UP):
          view.moveCam(0, CAM_MOVE_STEP, 0);
          break;
        case (KeyEvent.VK_DOWN):
          view.moveCam(0, -CAM_MOVE_STEP, 0);
          break;
        case (KeyEvent.VK_LEFT):
          view.moveCam(-CAM_MOVE_STEP, 0, 0);
          break;
        case (KeyEvent.VK_RIGHT):
          view.moveCam(CAM_MOVE_STEP, 0, 0);
          break;
        case (KeyEvent.VK_A):
          view.rotateCam(0, -CAM_ROT_STEP, 0);
          break;
        case (KeyEvent.VK_D):
          view.rotateCam(0, CAM_ROT_STEP, 0);
          break;
        case (KeyEvent.VK_W):
          view.rotateCam(-CAM_ROT_STEP, 0, 0);
          break;
        case (KeyEvent.VK_S):
          view.rotateCam(CAM_ROT_STEP, 0, 0);
          break;
        case (KeyEvent.VK_F):
          view.rotateCam(0, 0, CAM_ROT_STEP);
          break;
        case (KeyEvent.VK_C):
          view.rotateCam(0, 0, -CAM_ROT_STEP);
          break;
        case (KeyEvent.VK_PAGE_UP):
          view.moveCam(0, 0, -CAM_MOVE_STEP);
          break;
